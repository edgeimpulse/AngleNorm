...
[AngleForge](https://huggingface.co/spaces/eoinedge/angleforge) Hugging Face
...
3. Sends it to the AngleForge Space `grab_viewpoints` API for the selected angle.
...
| `angleforge-space` | HF Space id running the model (default `eoinedge/angleforge`). |
